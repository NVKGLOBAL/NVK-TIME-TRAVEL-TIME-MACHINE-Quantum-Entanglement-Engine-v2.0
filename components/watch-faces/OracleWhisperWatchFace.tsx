...
interface OracleWhisperWatchFaceProps {
    time: Date;
    modeName: string;
}

const OracleWhisperWatchFace: React.FC<OracleWhisperWatchFaceProps> = ({ time, modeName }) => {
    ...
    useEffect(() => {
        ...
        const render = (timestamp: number) => {
            ...
            // Oracle Whisper (Floating Glyphs)
...
export default OracleWhisperWatchFace;
