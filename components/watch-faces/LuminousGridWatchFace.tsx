...
interface LuminousGridWatchFaceProps {
    time: Date;
    modeName: string;
}

const LuminousGridWatchFace: React.FC<LuminousGridWatchFaceProps> = ({ time, modeName }) => {
...
export default LuminousGridWatchFace;
