...
interface GlimmerGridWatchFaceProps {
    time: Date;
    modeName: string;
}

const GlimmerGridWatchFace: React.FC<GlimmerGridWatchFaceProps> = ({ time, modeName }) => {
...
export default GlimmerGridWatchFace;
