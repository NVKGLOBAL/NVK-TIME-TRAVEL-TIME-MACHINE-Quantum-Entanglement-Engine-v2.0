...
const ChronoSphereWatchFace: React.FC<WatchFaceProps> = ({ time, modeName = "Chrono Sphere" }) => {
    ...
    useEffect(() => {
        ...
        const render = (timestamp: number) => {
            ...
            const grad = ctx.createRadialGradient(centerX - sphereRadius * 0.3, centerY - sphereRadius * 0.3, 0, centerX, centerY, sphereRadius);
            grad.addColorStop(0, '#0ff');
            grad.addColorStop(0.5, '#008b8b');
...
export default ChronoSphereWatchFace;
